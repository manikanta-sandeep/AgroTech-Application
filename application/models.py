...
class user(db.Model):
    ...
    role=db.Column(db.Integer, ForeignKey("role.role_id"))
...
class roles(db.Model):
    __tablename__="roles"
    roles_id=db.Column(db.Integer, primary_key=True, autoincrement=True)
...
class inventory(db.Model):
    ...
    transport_req=db.Column(db.Integer)
    process_req=db.Column(db.Integer)
